...
testo={['MPV: ', num2str(mpv), ' keV'];['$\sigma$ = ', num2str(fitres.sigma), ' keV'];['Entries: ' num2str(length(val))]};
annotation('textbox',[.7 .805 .1 .1],'FitHeightToText','on','String',testo,'Fontsize',12);
if nargout
    vpp=mpv;
    sig=fitres.sigma;
    mv=mean(val);
